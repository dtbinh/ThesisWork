...
static void refGen_formation( double *, double *, double *, double * );
...
void refGen_formation( double *pos_agent1, double *pos_agent2, double *pos_self, double *ref_formation ) {
	double points[4];	// intersection points of the agents, first ind is the point number
